...
describe('로또 구입금액이 1000원일 때, 로또 수익률 계산 테스트', () => {
  ...
  test('로또 당첨 개수가 6개인 경우, 상금은 2,000,000,000이므로 수익률은 200,000,000 이다.', () => {
  ...
  test('로또 당첨 개수가 5개 + 보너스 번호인 경우, 상금은 30,000,000이므로 수익률은 3,000,000 이다.', () => {
  ...
  test('로또 당첨 개수가 5개인 경우, 상금은 1,500,000이므로 수익률은 150,000 이다.', () => {
