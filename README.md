...
`2단계 피드백으로부터 발생한 리팩토링`
- [x] 구입 금액 입력 리팩토링
  - [x] (유효성)10만원 이상은 입력이 안되도록
  - [x] 엔터를 누르면 구입 버튼이 눌리도록
  - [x] 스크롤로 로또 여러개일때 확인할수 있도록 구현
  - [x] 구입 버튼 한번 누르면 비활성화 시키기
- [x] 당첨번호 입력, 보너스번호 입력 리팩토링
  - [x] 한개를 입력한뒤 스페이스바나 엔터를 누르면 다른걸 포커싱하게 하기
- [ ] 결과 확인하기 
  - [ ] 모달창 엑스표 만들기
  - [ ] 모달창 배경화면 누르면 모달창 없어지게 만들기
  - [ ] 모달창 뒷부분은 터치 안되도록 수정
- [ ] 오류 출력하기
  - [ ] alert말고 다른 방법으로 수정하기.
