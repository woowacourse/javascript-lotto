...
- [ ] 지난 주 당첨 숫자를 입력한다.
  ...
  - [ ] 1에서 45 사이의 숫자만 입력할 수 있다.
  - [ ] 중복된 숫자는 입력할 수 없다.
- [ ] 모든 숫자의 입력을 완료하면, 결과 확인 버튼이 활성화된다.
- [ ] 결과 확인 버튼을 누르거나, 마지막 보너스 숫자에서 enter key를 눌러 당첨 숫자를 입력받는다.
  - [ ] 구매한 로또와 당첨 번호를 비교한다.
  - [ ] 당첨 개수를 계산한다.
  - [ ] 수익률을 계산한다.
  - [ ] 당첨 개수와 수익률을 modal을 통해 화면에 띄운다.
    - [ ] modal X를 누르면 modal이 닫힌다.
...
- 정상 로직
  ...
  - [ ] 결과 확인 버튼을 누르면 modal 창이 보인다.
  - [ ] modal의 X 버튼을 누르면 modal 창이 닫힌다.
