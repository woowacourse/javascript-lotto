...
- [] 티켓 구매 금액 입력 시, 발급 가능한 티켓 수량을 보여준다.
- [] 수동으로 번호 6자리를 입력해 티켓을 발급한다.
  - [] 발급 시, 발급 가능한 티켓 수량을 차감한다.
  - [] 중복된 번호 입력 시, 에러메시지와 함께 해당 번호 입력창을 비운다.
  - [] 발급 가능한 티켓이 없다면 수동 구매를 할 수 없다.
- [] 수동 구매 종료 시, 나머지 발급 가능한 티켓을 자동 구매한다.
