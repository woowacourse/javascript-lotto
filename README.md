...
- [x] 소비자는 수동 구매(스스로 구매 번호를 입력)를 할 수 있어야 한다.
  - [x] 수동 구매의 개수는 최대 입력한 금액 / 로또 가격 만큼만 가능하다.
  - [x] 수동 구매의 개수는 자연수만 가능하다.
  - [x] 수동 구매의 구매 번호는 1 ~ 45까지의 숫자만 가능하다.
  - [x] 수동 구매의 구매 번호는 중복된 번호가 존재할 수 없다.
- [x] 수동 구매와 자동 구매 개수를 입력할 수 있다.
  - [x] 자동 구매의 개수는 최대 입력한 금액 / 로또 가격 만큼만 가능하다.
  - [x] 자동 구매의 개수는 자연수만 가능하다.
...
- [x] 소비자는 자동 / 수동 구매를 선택할 수 있다.
- [x] 소비자는 자동으로 구매한 로또 개수만큼의 복권을 받는다.
- [x] 수동 구매를 선택한 경우 직접 로또 번호를 입력할 수 있다.
- [x] 입력한 금액 / 로또 가격이 0이 되면 결과 확인하기 버튼이 활성화된다.

- [x] 입력된 로또 번호 중 1 ~ 45 사이의 숫자가 아닌 숫자가 있다면 안내메시지를 출력한다.
- [x] 입력된 번호 중 중복된 번호가 있다면 안내메시지를 출력한다.
<br>
