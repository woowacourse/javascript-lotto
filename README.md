...
- [ ] 페이지의 상단에서 헤더를 볼 수 있다.
  - [ ] '행운의 로또'라는 글자를 볼 수 있다.
- [ ] 구입 박스는 페이지의 정가운데에서 볼 수 있다.
  - [ ] 복권 안에는 '내 번호 당첨 확인'이라는 제목을 볼 수 있다.

### 구입 전

- [ ] 구입 금액 입력 폼을 볼 수 있다.
  - [ ] '구입할 금액을 입력해주세요'라는 문구를 볼 수 있다.
  - [ ] 금액을 입력받는 창을 볼 수 있다.
    - [ ] '금액'으로 placeholder를 적용한다.
  - [ ] '구입' 이라고 적힌 버튼을 볼 수 있다.

- [ ] 구입 버튼을 클릭하면 하단에 '로또 구입 후' 나온다.

### 구입 후

- [ ] '총 N개를 구매하였습니다'라는 문구를 볼 수 있다.
- [ ] 구매한 로또볼 수 있다.
  - [ ] 뽑힌 랜덤 숫자를 볼 수 있다.
  - [ ] 뽑힌 랜덤 숫자 앞에 복권 이미지를 볼 수 있다.
