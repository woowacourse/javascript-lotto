...
- [ ] 소비자는 수동 구매(스스로 구매 번호를 입력)를 할 수 있어야 한다.
  ...
  - [ ] 사용자는 6개의 숫자를 입력할 수 있다.
  - [ ] 입력 후 확인 / 엔터 키를 이용하여 수동구매를 진행한다.
  - [ ] 한 번에 하나의 로또를 생성할 수 있다.
  - [ ] 몇개의 로또가 남았는지 화면에 표시한다.
- [ ] 수동 구매 후 남는 금액이 있다면 자동으로 구매할 수 있어야 한다.
  - [ ] 사용자는 수동구매와 자동구매를 선택할 수 있다. (default : 수동구매)
- [ ] 위 기능들이 정상적으로 동작하는지 Cypress를 이용해 테스트한다.

### step3 테스트 항목

- [ ] 사용자가 구매금액을 입력한 후 확인 버튼을 누르면 수동구매 폼이 나온다.
- [ ] 사용자는 수동구매 폼의 Input 에 1~45사이의 숫자를 입력한 후, 확인버튼을 누르면, 로또 목록에 로또가 하나씩 추가되는 것을 볼 수 있다.
- [ ] 사용자는 '자동 구매' 버튼을 눌러 자동으로 남은 만큼의 로또를 생성할 수 있다.
