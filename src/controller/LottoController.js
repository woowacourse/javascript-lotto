import Lotto from "../step1/domains/Lotto";
import LottoResult from "../step1/domains/LottoResult";
import LottoStore from "../step1/domains/LottoStore";
import WinningLotto from "../step1/domains/WinningLotto";
import InputView from "../step1/views/InputView";
import OutputView from "../step1/views/OutputView";
...
class LottoController {
  ...
  #printWinningResult() {
    ...
    const returnRate = lottoResult.calculateReturnRate(this.#lottos.length);
