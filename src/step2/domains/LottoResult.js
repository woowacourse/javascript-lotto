class LottoResult {
  ...
  static #getLottoRank(matchedCount, hasBonusNumber) {
    if (matchedCount === LottoResult.#MATCHED_COUNT.six)
      return LottoResult.#LOTTO_RANKS.first;
    if (matchedCount === LottoResult.#MATCHED_COUNT.five && hasBonusNumber)
      return LottoResult.#LOTTO_RANKS.second;
    if (matchedCount === LottoResult.#MATCHED_COUNT.five)
      return LottoResult.#LOTTO_RANKS.third;
    if (matchedCount === LottoResult.#MATCHED_COUNT.four)
      return LottoResult.#LOTTO_RANKS.fourth;
    if (matchedCount === LottoResult.#MATCHED_COUNT.three)
      return LottoResult.#LOTTO_RANKS.fifth;
