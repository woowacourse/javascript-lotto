...
const ERROR_MESSAGE = {
  ...
  lottoMoneyNotInRange: `구입 금액은 ${LottoMoney.MIN}원 이상 ${LottoMoney.MAX}원 이하의 숫자로 입력해야 합니다.`,
  lottoMoneyNotInteger: `구입 금액은 정수로 입력해야 합니다.`,

  lottoNumberNotNumber: `각 로또 번호는 숫자로 입력해야 합니다.`,
  lottoNumberOutOfRange: `각 로또 번호는 ${LottoNumber.MIN} 이상 ${LottoNumber.MAX} 이하의 숫자로 입력해야 합니다.`,
