const Messages = {
  ...
  ERROR_MONEY_AMOUNT_SHOULD_MULTIPLE_OF: '1000원 단위로 금액을 주어야 합니다.',
  ERROR_LOTTO_NUMBER_SHOULD_NUMERIC: '로또 번호는 숫자로 이루어져 있어야 합니다.',
  ERROR_LOTTO_NUMBER_SHOULD_BETWEEN: '로또 번호는 1에서 45 사이의 숫자여야 합니다.',
  ERROR_LOTTO_NUMBERS_SHOULD_ARRAY: '로또 번호는 배열 타입이어야 합니다.',
  ERROR_LOTTO_NUMBERS_SHOULD_LENGTH_OF: '로또 번호는 6자리여야 합니다.',
