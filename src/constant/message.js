const { LOTTO, RANK, COMMAND } = require('./setting');
...
const ERROR_MESSAGE = {
  LESS_THAN_MINIMUM: `[ERROR] 구입 금액은 ${LOTTO.UNIT.toLocaleString()}원 이상이어야 합니다.`,
  HAS_CHANGE: `[ERROR] 구입 금액은 ${LOTTO.UNIT.toLocaleString()}원 단위이어야 합니다.`,
  OUT_OF_RANGE: `[ERROR] ${LOTTO.MIN_NUMBER_RANGE}~${LOTTO.MAX_NUMBER_RANGE}사이의 숫자이어야 합니다.`,
