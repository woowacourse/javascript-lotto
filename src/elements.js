...
export const $purchase = $(SELECTOR.PURCHASE);
export const $purchaseButton = $(SELECTOR.PURCHASE_BUTTON);
export const $purchaseInputWrapper = $(SELECTOR.PURCHASE_INPUT_WRAPPER);
