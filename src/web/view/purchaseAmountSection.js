...
const purchaseAmountSection = `
  <section class="lotto-game-section purchase-amount-section">
    ...
    <form id="purchase-amount-form">
      <input type="number" id="purchase-amount-input" placeholder="금액 (1,000원 단위의 금액을 입력하세요)" min="${PURCHASE_AMOUNT.MIN}" max="${PURCHASE_AMOUNT.MAX}" step="${PURCHASE_AMOUNT.STEP}"/>
