  ...
  template() {
    return `    
      <form class="money-input-form">
        ...
        <div>
          <input class="money-input clickable" type="number" min=${MONEY.MIN} max=${MONEY.MAX} step=${MONEY.UNIT} placeholder="금액" required></input>
          <input class="money-input-btn clickable" type="submit" value="구입"></input>
        </div>
      </form>
    `;
  }
