...
export const $manualPurchaseForm = $("#manual-purchase-form");
export const $manualPurchaseNumberInputs = $(".manual-purchase-number");
export const $purchase = $("#purchase");
export const $purchaseProgress = $("#purchase-progress");
export const $autoPurchaseButton = $("#auto-purchase-button");
