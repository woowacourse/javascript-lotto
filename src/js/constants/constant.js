...
export const ERROR_MESSAGE = {
  ...
  LOTTO_CANNOT_BE_EMPTY: "당첨 번호를 모두 입력해주세요.",
  LOTTO_CANNOT_BE_DUPLICATED: "당첨 번호는 중복되면 안됩니다.",
  LOTTO_CANNOT_BE_OUT_RANGE: "당첨 번호는 1이상 45이하의 숫자여야 합니다.",
  LOTTO_CANNOT_BE_FLOAT: "당첨 번호는 소수가 될 수 없습니다.",
}
