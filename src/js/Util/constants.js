...
export const ALERT_MESSAGE = {
  ...
  INVALID_MONEY_RANGE: `${STANDARD_NUMBER.ONE_TICKET_PRICE}원 이상, ${STANDARD_NUMBER.MAX_PURCHASE_PRICE}원 이하만 입력 가능합니다.`,
  NOT_THOUSAND_MULTIPLES: `${STANDARD_NUMBER.ONE_TICKET_PRICE}원 단위로만 입력 가능합니다.`,

  BLANK_INCLUDED: "공백은 입력 불가능합니다.",
  INVALID_WINNING_NUMBER_RANGE: `${STANDARD_NUMBER.MIN_LOTTO_NUMBER}에서 ${STANDARD_NUMBER.MAX_LOTTO_NUMBER}까지의 숫자만 입력 가능합니다.`,
