...
- [x] 로또 구매
  - [x] "구입" 버튼 클릭 시 구매한 로또 목록 및 당첨 번호 및 보너스 번호 입력 폼 렌더링
  - [x] "구입" 버튼 클릭 시 잘못된 입력을 했다면 오류 메시지 렌더
- [x] 구매한 로또 목록 확인
- [x] 당첨 번호 및 보너스 번호 지정
  - [x] 당첨 번호를 잘못 입력 했다면 오류 메시지 렌더
  - [x] 보너스 번호를 잘못 입력 했다면 오류 메시지 렌더
- [x] 당첨 통계 확인
  - [x] "결과 확인하기" 버튼 클릭 시 모달 오픈
- [x] 게임 재시작
  - [x] "다시 시작하기" 버튼 클릭 시 모든 입력 및 내역 초기화
