...
- 당첨 통계 확인 기능
  - [ ] 일치 갯수가 `3개`인 로또 갯수를 확인할 수 있다.
  - [ ] 일치 갯수가 `4개`인 로또 갯수를 확인할 수 있다.
  - [ ] 일치 갯수가 `5개`인 로또 갯수를 확인할 수 있다.
  - [ ] 일치 갯수가 `5개+보너스볼`인 로또 갯수를 확인할 수 있다.
  - [ ] 일치 갯수가 `6개`인 로또 갯수를 확인할 수 있다.
- 수익률 확인 기능
  - [ ] 총 수익률을 확인할 수 있다.
