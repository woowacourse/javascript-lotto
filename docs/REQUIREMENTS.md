...
- [x] feat: 구입 금액 제출 후 버튼 비활성화
- [x] feat: 구입 금액 제출 후 인풋 비활성화
- [x] feat: 최대 구매 금액 설정하기
- [x] feat: 모달창 ESC로 닫기
- [x] feat: 모달창 배경 클릭해서 닫기
...
- [x] refactor: font css 가독성
- [x] refactor: 중복되는 스타일 같은 class으로 묶기
- [x] refactor: 객체로 데이터 관리
- [x] refactor: 로또를 관리하는 객체 만들기
